...
export interface QueryBehavior<TData = unknown, TError = unknown, TQueryFnData = TData> {
...
export declare class Query<TData = unknown, TError = unknown, TQueryFnData = TData> {
    queryKey: QueryKey;
    queryHash: string;
    options: QueryOptions<TData, TError, TQueryFnData>;
    ...
    invalidate(): void;
    fetch(options?: QueryOptions<TData, TError, TQueryFnData>, fetchOptions?: FetchOptions): Promise<TData>;
    private dispatch;
    protected getDefaultState(options: QueryOptions<TData, TError, TQueryFnData>): QueryState<TData, TError>;

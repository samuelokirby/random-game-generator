...
import { DefaultOptions, FetchQueryOptions, InvalidateOptions, InvalidateQueryFilters, MutationKey, MutationObserverOptions, MutationOptions, QueryFunction, QueryKey, QueryObserverOptions, QueryOptions, RefetchOptions, ResetOptions } from './types';
...
export declare class QueryClient {
    ...
    fetchQuery<TData = unknown, TError = unknown, TQueryFnData = TData>(options: FetchQueryOptions<TData, TError, TQueryFnData>): Promise<TData>;
    fetchQuery<TData = unknown, TError = unknown, TQueryFnData = TData>(queryKey: QueryKey, options?: FetchQueryOptions<TData, TError, TQueryFnData>): Promise<TData>;
    fetchQuery<TData = unknown, TError = unknown, TQueryFnData = TData>(queryKey: QueryKey, queryFn: QueryFunction<TQueryFnData | TData>, options?: FetchQueryOptions<TData, TError, TQueryFnData>): Promise<TData>;

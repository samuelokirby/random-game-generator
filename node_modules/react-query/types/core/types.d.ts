...
export interface QueryOptions<TData = unknown, TError = unknown, TQueryFnData = TData> {
    /**
...
export interface QueryObserverOptions<TData = unknown, TError = unknown, TQueryFnData = TData, TQueryData = TQueryFnData> extends QueryOptions<TData, TError, TQueryFnData> {
    /**
...
export interface InfiniteQueryObserverOptions<TData = unknown, TError = unknown, TQueryFnData = TData, TQueryData = TQueryFnData> extends QueryObserverOptions<InfiniteData<TData>, TError, TQueryFnData, InfiniteData<TQueryData>> {
}
export interface FetchQueryOptions<TData = unknown, TError = unknown, TQueryFnData = TData> extends QueryOptions<TData, TError, TQueryFnData> {
    /**
     * The time in milliseconds after data is considered stale.
